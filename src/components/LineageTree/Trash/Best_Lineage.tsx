...
//const FIXED_LONG_SCALE = 3.8; 
const FIXED_LONG_SCALE = 1.8; 
const celllabel_font_size = 14;
const line_col = "#ccc";

// const scaleExtentMin = 0.7;
// const scaleExtentMax = 1.3
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    cellLineages.forEach((cell, panelIdx) => {
      ...
      g_label.selectAll<SVGLineElement, string>("line")
      ...
      g_label.selectAll<SVGTextElement, string>("text")
  ...
  }, [LineageDataGroups, ColorDataGroups, colorMode,line_width]);
